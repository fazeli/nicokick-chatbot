...
exports.EnhancedChatbotService = void 0;
const chatUtils_1 = require("../../client/src/lib/chatUtils");
const embeddingService_1 = require("./embeddingService");
class EnhancedChatbotService {
    constructor(storage) {
        this.similarityThreshold = 0.65; // Adjust based on model's characteristics
    ...
    async generateResponse(sessionId, userMessage) {
        ...
        try {
            const userMessageEmbedding = await embeddingService_1.embeddingService.generateEmbedding(userMessage);
            // Search for similar FAQs using embeddings
            const matchedFaqs = await this.storage.searchFaqsByEmbedding(userMessageEmbedding, this.similarityThreshold);
